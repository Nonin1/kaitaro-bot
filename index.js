...
// ----------------------
// Канал, куда бот будет писать поздравления
const CHANNEL_ID = "1488262489383899460";

// ----------------------
// Роли и поздравления для 10 этапов
const stages = {
...
// ----------------------
// Множество, чтобы поздравлять каждого пользователя с каждой ролью только один раз
